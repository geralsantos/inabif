...
//		}
	...
	* @access   public
	*/
	function send($data, $timeout=0, $response_timeout=0, $cookies=NULL) {
	...
	* @deprecated
	*/
	function sendHTTPS($data, $timeout=0, $response_timeout=0, $cookies) {
...
class nusoap_client extends nusoap_base  {
	...
	* @access   private
	*/
	function send($msg, $soapaction = '', $timeout=0, $response_timeout=0) {
		$this->checkCookies();
		// detect transport
		switch(true){
			// http(s)
