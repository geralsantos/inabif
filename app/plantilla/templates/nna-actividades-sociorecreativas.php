                    ...
                    <form class="form-horizontal" v-on:submit.prevent="guardar">
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" v-model="NNAArte" name="NNAArte" placeholder="" class="form-control">
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                <div class=" "><label for="text-input" class=" form-control-label">N° Biohuerto</label>
                                <input type="number" v-model="NNABiohuerto" name="NNABiohuerto" placeholder="" class="form-control">  </div>
                            </div>
                            <div class="form-group col-md-4">
                                <div class=" ">
                                <label for="text-input" class=" form-control-label">N° Calzado y Zapatería</label>
                                <input type="number" v-model="NNAZapateria" name="NNAZapateria" placeholder="" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" v-model="NNACarpinteria" name="NNACarpinteria" placeholder="" class="form-control">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="text-input" class=" form-control-label">N° Cerámica</label>
                                <input type="number" v-model="NNACeramica" name="NNACeramica" placeholder="" class="form-control">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="text-input" class=" form-control-label">N° Crianza de animales</label>
                                <input type="number" v-model="NNACrianzaAnimales" name="NNACrianzaAnimales" placeholder="" class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" v-model="NNAPintura" name="NNAPintura" placeholder="" class="form-control">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="text-input" class=" form-control-label">N° Tejidos y Telares</label>
                                <input type="number" v-model="NNATejidos" name="NNATejidos" placeholder="" class="form-control">

                            </div>
                            <div class="form-group col-md-4">
                                <label for="text-input" class=" form-control-label">N° Futbol /Voley/ Artes marciales /Natación /Atletismo, entre otros</label>
                                <input type="number" v-model="NNADeportes" name="NNADeportes" placeholder="" class="form-control">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" v-model="NNATalleres" name="NNATalleres" placeholder="" class="form-control">
                            </div>
                        </div>
