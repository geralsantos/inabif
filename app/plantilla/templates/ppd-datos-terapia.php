                ...
                <div class="card-body card-block">
                    ...
                    <form class="form-horizontal" v-on:submit.prevent="guardar">
                        ...
                        <div class="form-group col-md-4">
                                ...
                                <input type="number" min="0"  v-model="CarNumReeducaion" name="CarNumReeducaion" placeholder="" class="form-control">
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" min="0"  v-model="CarParticipaPsicomotricidad" name="CarParticipaPsicomotricidad" placeholder="" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" min="0"  v-model="CarFisioterapia" name="CarFisioterapia" placeholder="" class="form-control">
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" min="0"  v-model="CarDeportesAdaptados" name="CarDeportesAdaptados" placeholder="" class="form-control">
                            </div>
                            <div class="form-group col-md-4">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" min="0"  v-model="CarTerapiaLenguaje" name="CarTerapiaLenguaje" placeholder="" class="form-control">
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" min="0"  v-model="CarDesarrolloLenguaje" name="CarDesarrolloLenguaje" placeholder="" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" min="0"  v-model="CarDesrrolloActividadesBasicas" name="CarDesrrolloActividadesBasicas" placeholder="" class="form-control">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="text-input" class=" form-control-label">N° de veces que Participa en actividades Instrumentales Básicas</label>
                                <input type="number" min="0"  v-model="CarInstrumentalesBasicas" name="CarInstrumentalesBasicas" placeholder="" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class='row'>
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" min="0"  v-model="CarInstrumentalesComplejas" name="CarInstrumentalesComplejas" placeholder="" class="form-control">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="text-input" class=" form-control-label">N° de veces que Participa en actividades de Intervención sensorial</label>
                                <input type="number" min="0"  v-model="CarIntervensionSensorial" name="CarIntervensionSensorial" placeholder="" class="form-control">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="text-input" class=" form-control-label">N° de veces que Participa en actividades Senso receptivas</label>
                                <input type="number" min="0"  v-model="CarSensoReceptivas" name="CarSensoReceptivas" placeholder="" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class='row'>
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" min="0"  v-model="CarElavoracionOrteticos" name="CarElavoracionOrteticos" placeholder="" class="form-control">
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" min="0"  v-model="CarAdaptacionSilla" name="CarAdaptacionSilla" placeholder="" class="form-control">
                            </div>
