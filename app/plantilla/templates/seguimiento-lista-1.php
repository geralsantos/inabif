                            ...
                            <div class="table-responsive">
                                ...
                                <tbody class="text-center">
                                    <tr v-for="centro in centros" style="text-align:left;">
                                        ...
                                        <td v-if="isempty(centro.ESTADO_COMPLETO) && mostrar_completado"><label class="form-control-label">Completado</label><input type="checkbox" class="form-control" @change="verificar_centro(centro.ID_CENTRO)" :checked="!isempty(centro.ESTADO_COMPLETO)"  class="form-control" ></td>
