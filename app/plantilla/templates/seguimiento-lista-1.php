...
=======
                                        <td v-if="isempty(centro.ESTADO_COMPLETO) && mostrar_completado"><label class="form-control-label">Completado</label><input type="checkbox" class="form-control" @change="completar_matriz(centro.ID_CENTRO)" :checked="!isempty(centro.ESTADO_COMPLETO)" :disabled="" class="form-control" ></td>
<<<<<<< HEAD
                                        <td v-if="!isempty(centro.ESTADO_COMPLETO) && mostrar_completado"> <button class="btn btn-success" @click="generar_matriz(centro.ID_CENTRO)">Generar Matriz</button></td>
=======
                                        <td v-if="isempty(centro.ESTADO_COMPLETO) && mostrar_completado"> <button class="btn btn-success" @click="generar_matriz(centro.ID_CENTRO)">Generar Matriz</button></td>
>>>>>>> 0e4f6e8e807e0bc00e61229663de8dd9ab53ca15
>>>>>>> 01c9b15952616a08eafe64a9b99b77be60488dfc
                                    </tr>
