                            ...
                            <div class="table-responsive">
                                ...
                                <tbody class="text-center">
                                    <tr v-for="centro in centros">
                                        ...
                                        <td><button class="btn btn-primary" @click="ver_grupos(centro.ID_CENTRO)">Ver</button></td><td v-if="isempty(centro.ESTADO_COMPLETO) && mostrar_completado"><label class="form-control-label">Completado</label><input type="checkbox" class="form-control" @change="completar_matriz(centro.ID_CENTRO)" :checked="!isempty(centro.ESTADO_COMPLETO)"  class="form-control" ></td>
