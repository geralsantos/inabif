                            ...
                            <div class="table-responsive">
                                ...
                                <tbody class="text-center">
                                    <tr v-for="centro in centros" style="text-align:left;">
                                        ...
                                        <td v-if="isempty(centro.ESTADO_COMPLETO) && mostrar_completado"><label class="form-control-label">Completado</label><input type="checkbox" id="check_completado_seg_1" class="form-control" @change="verificar_centro(centro.ID_CENTRO)" :checked="!isempty(centro.ESTADO_COMPLETO)" ></td>
