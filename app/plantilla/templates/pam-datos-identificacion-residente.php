                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="departamento_procedente_id" v-model="departamento_procedente_id" @change="buscar_provincias()" class="form-control">
                                    <option v-for="departamento in departamentos" :value="departamento.CODDEPT">{{departamento.NOMBRE}}</option>
                                </select>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <select name="departamento_nacimiento_id" v-model="departamento_nacimiento_id" @change="buscar_distritos()" class="form-control">
                                    <option v-for="departamento in departamentos2" :value="departamento.CODDEPT">{{departamento.NOMBRE}}</option>
                                </select>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <select name="provincia_nacimiento_id" v-model="provincia_nacimiento_id" @change="buscar_distritos()" class="form-control">
                                    <option v-for="provincia in provincias" :value="provincia.CODPROV">{{provincia.NOMBRE}}</option>
                                </select>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <select name="distrito_nacimiento_id" v-model="distrito_nacimiento_id" class="form-control">
                                    <option v-for="distrito in distritos" :value="distrito.CODDIST">{{distrito.NOMBRE}}</option>
                                </select>
                                </div>
                            </div>
