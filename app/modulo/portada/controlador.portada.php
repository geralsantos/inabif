...
/*ccs.Nom_Entidad, ccs.Cod_Linea ,ccs.Linea_Intervencion , ccs.Cod_Servicio , ccs.Nom_Servicio, ccs.Ubigeo_Ine, ccs.Departamento_CAtencion, ccs.Provincia_CAtencion, ccs.Distrito_CAtencion, ccs.Centro_Poblado, ccs.Centro_Residencia*/
        ...
        ,centro_atencion ca 
        ,residente re
        where cu.residente_id(+)=re.id and ca.id(+)= re.centro_id and cda.residente_id(+)=re.id and cci.residente_id(+)=re.id and csn.residente_id(+)=re.id and csm.residente_id(+)=re.id and ct.residente_id(+)=re.id and cac.residente_id(+)=re.id and cap.residente_id(+)=re.id and cec.residente_id(+)=re.id and cts.residente_id(+)=re.id and cas.residente_id(+)=re.id and cep.residente_id(+)=re.id and cee.residente_id(+)=re.id and ces.residente_id(+)=re.id and ctf.residente_id(+)=re.id and cen.residente_id(+)=re.id and cets.residente_id(+)=re.id and ceg.residente_id(+)=re.id and re.tipo_centro_id=1 and (to_char(cu.fecha_creacion,\'DD-MON-YY\') '.$fecha.') and (to_char(ca.fecha_creacion,\'DD-MON-YY\') '.$fecha.') and (to_char(cda.fecha_creacion,\'DD-MON-YY\') '.$fecha.') and (to_char(cci.fecha_creacion,\'DD-MON-YY\')  '.$fecha.') and (to_char(csn.fecha_creacion,\'DD-MON-YY\')  '.$fecha.') and (to_char(csm.fecha_creacion,\'DD-MON-YY\')  '.$fecha.') and (to_char(ct.fecha_creacion,\'DD-MON-YY\')  '.$fecha.') and (to_char(cac.fecha_creacion,\'DD-MON-YY\')  '.$fecha.') and (to_char(cap.fecha_creacion,\'DD-MON-YY\')  '.$fecha.') and (to_char(cec.fecha_creacion,\'DD-MON-YY\')  '.$fecha.') and (to_char(cts.fecha_creacion,\'DD-MON-YY\')  '.$fecha.') and (to_char(cas.fecha_creacion,\'DD-MON-YY\')  '.$fecha.') and (to_char(cep.fecha_creacion,\'DD-MON-YY\')  '.$fecha.') and (to_char(cee.fecha_creacion,\'DD-MON-YY\')  '.$fecha.') and (to_char(ces.fecha_creacion,\'DD-MON-YY\')  '.$fecha.') and (to_char(ctf.fecha_creacion,\'DD-MON-YY\')  '.$fecha.') and (to_char(cen.fecha_creacion,\'DD-MON-YY\')  '.$fecha.') and (to_char(cets.fecha_creacion,\'DD-MON-YY\')  '.$fecha.') and (to_char(ceg.fecha_creacion,\'DD-MON-YY\')  '.$fecha.')';
        $modulos = $modelo->executeQuery($modulos);
        $residentes = array();
        $grupo_html = "";
