...
class portada extends App{
  ...
  public function mostrar_matrices(){
    ...
    public function descargar_reporte_matriz_general(){
      ...
      echo $centros = "select distinct cad.id,ca.nom_ca as nombre_centro,ca.tipo_centro_id,tc.nombre as nombre_tipo_centro,to_char(cad.fecha_matriz,'DD-MON-YY HH24:MI') as fecha_matriz from centro_atencion_detalle cad
