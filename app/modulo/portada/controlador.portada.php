...
class portada extends App{
  ...
  public function mostrar_modulo(){
    ...
    $sql = "select re.nombre,re.apellido_p, nt.* EXCEPT nt.TIPO_CENTRO_ID from ".$nombre_tabla." nt inner join residente re on (re.id=nt.residente_id) where to_char(nt.fecha_creacion, 'MON-YY') =UPPER('".date("M-y")."')";
