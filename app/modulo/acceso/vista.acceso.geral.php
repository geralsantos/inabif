...
/* $mdl->createTable ("drop sequence seq_Carproblematica_familiar");
    */
    ...
    $x->executeQuery("insert into usuarios (id,centro_id ,nivel ,nombre ,apellido,correo ,dni,numcel,usuario ,clave , fecha_creacion,usuario_crea,usuario_edita)
    values(1,1,1,'ppd','ppd','ppd@gmail.com','76934493','123456789','ppd',123,sysdate,1,1)");
    $x->executeQuery("insert into usuarios (id,centro_id ,nivel ,nombre ,apellido,correo ,dni,numcel,usuario ,clave , fecha_creacion,usuario_crea,usuario_edita)
    values(2,2,1,'pam','pam','pam@gmail.com','76934494','123456789','pam',123,sysdate,1,1)");
    $x->executeQuery("insert into usuarios (id,centro_id ,nivel ,nombre ,apellido,correo ,dni,numcel,usuario ,clave , fecha_creacion,usuario_crea,usuario_edita)
    values(3,3,1,'nna','nna','nna@gmail.com','76934495','123456789','nna',123,sysdate,1,1)");
