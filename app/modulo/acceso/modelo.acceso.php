...
class modeloAcceso extends MySQL{
    ...
    public function getSesion($usuario, $clave){
        try {
            ...
            $usuario = $this->executeQuery("select us.*,us.id as id_usuario,ca.id as id_centro,tc.tipo_centro_id,tc.nombre as tipo_centro_nombre,ca.nom_ca  from usuarios us 
