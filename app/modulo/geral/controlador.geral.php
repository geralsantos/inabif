    ...
    $html = "";
      ...
      if (($modulo["NOMBRE_TABLA"])!="") 
      {
        ...
        $modulo_html .="<tr><td></td><td>".$modulo["NOMBRE_MODULO"]."</td></tr>";
				echo $grupos = "select nt.* from ".$modulo["NOMBRE_TABLA"]." nt where nt.tipo_centro_id=".$centro["TIPO_CENTRO_ID"]." and nt.periodo_mes=".date("m")." and nt.periodo_anio=".date("Y")." and nt.residente_id= ". $id_residente." and nt.centro_id=".$centro["ID"]." order by nt.id desc";
				$grupos = $modelo->executeQuery($grupos);
