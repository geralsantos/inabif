...
ini_set('session.gc_maxlifetime','1200');*/
  ...
  $html2 ="";
    ...
    $html = "";
		foreach ($modulos as $key => $modulo)
		{
      if (($modulo["NOMBRE_TABLA"])=="CarIdentificacionUsuario" || ($modulo["NOMBRE_TABLA"])=="CarDatosAdmision" || ($modulo["NOMBRE_TABLA"])=="CarCondicionIngreso" ) 
      {
