...
(SELECT NOMPROV FROM ubigeo WHERE coddist=CarIdentificacionUsuario.Provincia_Procedencia) as "Provincia de nac" ,
...
(SELECT nombre FROM pam_tipo_documento_identidad WHERE id=CarCondicionIngreso.Tipo_Documento) as "Tipo documento de identidad",
 ...
 (SELECT nombre FROM pam_clasif_socioeconomico where id = CarCondicionIngreso.Clasficacion_Socioeconomica) as "Clasificación Socio. (SISFOH)",
"" as "Cobertura médica",
...
(SELECT NOMPROV FROM ubigeo WHERE coddist=NNAInscripcionResidente.provincia_nacimiento_id) as "Provincia de nac" ,
