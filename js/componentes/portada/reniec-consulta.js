Vue.component('reniec-consulta', {
    ...
    methods:{
        ...
        actualiza_reniec(){
            if (!isempty(this.id_residente)) {
                let where = {dni:this.NumDoc,cboopcionreniec:this.cboopcionreniec,Apellido_p:this.data_reniec.Apellido_p,Apellido_m:this.data_reniec.Apellido_m,Nombres:this.data_reniec.Nombres,id_residente:this.id_residente};
