    ...
    methods:{
        ...
        guardar(){
            ...
            let valores = {
                ...
                Fecha_InicionA: (isempty(this.CarFIActividades)?null:moment(this.CarFIActividades, "DD-MM-YYYY").format("DD-MMM-YY")),
                Fecha_FinA: (isempty(this.CarFFActividades)?null:moment(this.CarFFActividades, "DD-MM-YYYY").format("DD-MMM-YY")),
